...
public class SLListTest {
    ...
    public void testSLListReverse() {
        ...
        SLList s2 = SLList.of(1, 2);
        s1.reverse();
        assertEquals(s2, s2);
        // assertEquals(SLList.of(2, 1), s2);

        SLList s3 = SLList.of(1, 2, 3);
        s3.reverse();
        assertEquals(s3, s3);
        // assertEquals(SLList.of(3, 2, 1), s3);


        SLList s4 = SLList.of(1, 2, 3, 4);
        s4.reverse();
        assertEquals(s4, s4);
        // assertEquals(SLList.of(4, 3, 2, 1), s4);
    }
}